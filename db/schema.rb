...
ActiveRecord::Schema.define(version: 2019_07_03_231700) do
  ...
  create_table "account_deletions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "person_id"
    t.datetime "completed_at"
    t.index ["person_id"], name: "index_account_deletions_on_person_id", unique: true
  end

  create_table "account_migrations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "old_person_id", null: false
    t.integer "new_person_id", null: false
    t.datetime "completed_at"
    t.index ["new_person_id"], name: "fk_rails_610fe19943"
  ...
  create_table "aspect_memberships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "aspect_visibilities", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "shareable_id", null: false
    t.integer "aspect_id", null: false
    t.string "shareable_type", default: "Post", null: false
    t.index ["aspect_id"], name: "index_aspect_visibilities_on_aspect_id"
    t.index ["shareable_id", "shareable_type", "aspect_id"], name: "index_aspect_visibilities_on_shareable_and_aspect_id", unique: true, length: { shareable_type: 189 }
    t.index ["shareable_id", "shareable_type"], name: "index_aspect_visibilities_on_shareable_id_and_shareable_type", length: { shareable_type: 190 }
  end

  create_table "aspects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["user_id", "name"], name: "index_aspects_on_user_id_and_name", unique: true, length: { name: 190 }
    t.index ["user_id"], name: "index_aspects_on_user_id"
  end

  create_table "authorizations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "blocks", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "user_id"
    t.integer "person_id"
    t.index ["user_id", "person_id"], name: "index_blocks_on_user_id_and_person_id", unique: true
  end

  create_table "chat_contacts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "jid", null: false
    t.string "name"
    t.string "ask", limit: 128
    t.string "subscription", limit: 128, null: false
    t.index ["user_id", "jid"], name: "index_chat_contacts_on_user_id_and_jid", unique: true, length: { jid: 190 }
  end

  create_table "chat_fragments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "chat_offline_messages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "comment_signatures", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["signature_order_id"], name: "comment_signatures_signature_orders_id_fk"
  end
  ...
  create_table "comments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["guid"], name: "index_comments_on_guid", unique: true, length: 191
  end

  create_table "contacts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "conversation_visibilities", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "conversations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "subject"
    t.string "guid", null: false
    t.integer "author_id", null: false
    t.datetime "created_at", null: false
    ...
    t.index ["guid"], name: "index_conversations_on_guid", unique: true, length: 191
  end

  create_table "invitation_codes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "token"
    t.integer "user_id"
    t.integer "count"
    t.datetime "created_at", null: false
  ...
  create_table "like_signatures", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "like_id", null: false
    t.text "author_signature", null: false
    t.integer "signature_order_id", null: false
    t.text "additional_data"
    t.index ["like_id"], name: "index_like_signatures_on_like_id", unique: true
    t.index ["signature_order_id"], name: "like_signatures_signature_orders_id_fk"
  end
  ...
  create_table "likes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["guid"], name: "index_likes_on_guid", unique: true, length: 191
  ...
  create_table "locations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "address"
    t.string "lat"
    t.string "lng"
  ...
  create_table "mentions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "mentions_container_id", null: false
    t.integer "person_id", null: false
    t.string "mentions_container_type", null: false
    t.index ["mentions_container_id", "mentions_container_type"], name: "index_mentions_on_mc_id_and_mc_type", length: { mentions_container_type: 191 }
    t.index ["person_id", "mentions_container_id", "mentions_container_type"], name: "index_mentions_on_person_and_mc_id_and_mc_type", unique: true, length: { mentions_container_type: 191 }
    t.index ["person_id"], name: "index_mentions_on_person_id"
  end

  create_table "messages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "conversation_id", null: false
    t.integer "author_id", null: false
    t.string "guid", null: false
    t.text "text", null: false
    ...
    t.index ["guid"], name: "index_messages_on_guid", unique: true, length: 191
  end

  create_table "notification_actors", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "notifications", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["target_type", "target_id"], name: "index_notifications_on_target_type_and_target_id", length: { target_type: 190 }
  end

  create_table "o_auth_access_tokens", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["token"], name: "index_o_auth_access_tokens_on_token", unique: true, length: 191
  end

  create_table "o_auth_applications", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "user_id"
    t.string "client_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_o_auth_applications_on_client_id", unique: true, length: 191
    t.index ["user_id"], name: "index_o_auth_applications_on_user_id"
  end

  create_table "o_embed_caches", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "url", limit: 1024, null: false
    t.text "data", null: false
    t.index ["url"], name: "index_o_embed_caches_on_url", length: 191
  end

  create_table "open_graph_caches", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "title"
    t.string "ob_type"
    t.text "image"
    t.text "url"
  ...
  create_table "participations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "guid"
    t.integer "target_id"
    t.string "target_type", limit: 60, null: false
    t.integer "author_id"
    ...
    t.index ["guid"], name: "index_participations_on_guid", length: 191
  ...
  create_table "people", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.integer "pod_id"
    t.index ["diaspora_handle"], name: "index_people_on_diaspora_handle", unique: true, length: 191
    t.index ["guid"], name: "index_people_on_guid", unique: true, length: 191
    t.index ["owner_id"], name: "index_people_on_owner_id", unique: true
    t.index ["pod_id"], name: "people_pod_id_fk"
  end
  ...
  create_table "photos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["guid"], name: "index_photos_on_guid", unique: true, length: 191
    t.index ["status_message_guid"], name: "index_photos_on_status_message_guid", length: 191
  end

  create_table "pods", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["host", "port"], name: "index_pods_on_host_and_port", unique: true, length: { host: 190 }
    t.index ["offline_since"], name: "index_pods_on_offline_since"
    t.index ["status"], name: "index_pods_on_status"
  end

  create_table "poll_answers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "answer", null: false
    t.integer "poll_id", null: false
    t.string "guid"
    t.integer "vote_count", default: 0
    t.index ["guid"], name: "index_poll_answers_on_guid", unique: true, length: 191
    t.index ["poll_id"], name: "index_poll_answers_on_poll_id"
  end

  create_table "poll_participation_signatures", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["signature_order_id"], name: "poll_participation_signatures_signature_orders_id_fk"
  end

  create_table "poll_participations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["guid"], name: "index_poll_participations_on_guid", unique: true, length: 191
  ...
  create_table "polls", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["guid"], name: "index_polls_on_guid", unique: true, length: 191
  ...
  create_table "posts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.text "tumblr_ids"
    t.index ["author_id", "root_guid"], name: "index_posts_on_author_id_and_root_guid", unique: true, length: { root_guid: 190 }
    t.index ["author_id"], name: "index_posts_on_person_id"
    t.index ["created_at", "id"], name: "index_posts_on_created_at_and_id"
    t.index ["guid"], name: "index_posts_on_guid", unique: true, length: 191
    t.index ["id", "type"], name: "index_posts_on_id_and_type"
    t.index ["root_guid"], name: "index_posts_on_root_guid", length: 191
  end

  create_table "ppid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "o_auth_application_id"
    t.integer "user_id"
  ...
  create_table "profiles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "references", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "reports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "roles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "person_id"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id", "name"], name: "index_roles_on_person_id_and_name", unique: true, length: { name: 190 }
  end

  create_table "services", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["type", "uid"], name: "index_services_on_type_and_uid", length: { type: 64 }
    t.index ["user_id"], name: "index_services_on_user_id"
  end

  create_table "share_visibilities", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "shareable_id", null: false
  ...
  create_table "signature_orders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "order", null: false
    t.index ["order"], name: "index_signature_orders_on_order", unique: true, length: 191
  end

  create_table "simple_captcha_data", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "tag_followings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "taggings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["taggable_id", "taggable_type", "context"], name: "index_taggings_on_taggable_id_and_taggable_type_and_context", length: { taggable_type: 95, context: 95 }
  ...
  create_table "tags", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_tags_on_name", unique: true, length: 191
  end
  ...
  create_table "user_preferences", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "email_type"], name: "index_user_preferences_on_user_id_and_email_type", length: { email_type: 190 }
  end
  ...
  create_table "users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["username"], name: "index_users_on_username", unique: true, length: 191
  end
